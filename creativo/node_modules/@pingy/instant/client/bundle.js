...
module.exports = function connectionLost() {
  ...
  var style =
    'position: fixed; top: 0px; left: 0px; background: rgba(220, 220, 220, 0.9);';
  style +=
    'width: 100%; padding: 20px; text-align: center; border-bottom: 1px #555 solid;';
  style += 'z-index: 9999; text-shadow: 1px 1px 0px white;';

  var innerHtml =
    "Pingy has lost contact with this page. Live Reload won't work.<br />";
...
},{"./add":1,"./connectionLost":2,"./find":3,"./url":5,"sendevent":6}],5:[function(require,module,exports){
