...
const baconize = require('@pingy/export');
...
describe('baconize', () => {
  ...
  describe('preflight', () => {
    const emptyDir = Path.join(process.cwd(), 'empty-dir');
    const existingDir = Path.join(process.cwd(), 'examples');
    const enoentDir = Path.join(process.cwd(), 'enoent');
    ...
    it('should work (basic test)', () =>
      baconize.preflight(process.cwd()).then(info =>
    ...
    it('should have enoent output dir', () =>
      baconize.preflight(process.cwd(), enoentDir).then(info =>
        expect(info, 'to have properties', {
          empty: false,
          exists: true,
          nodeModules: true,
    ...
    it('should have existing non-empty output dir', () =>
      baconize.preflight(process.cwd(), existingDir).then(info => {
        expect(info, 'to have properties', {
          empty: false,
          exists: true,
          nodeModules: true,
    ...
    it('should have existing empty output dir', () =>
      baconize.preflight(process.cwd(), emptyDir).then(info =>
        expect(info, 'to have properties', {
          empty: false,
          exists: true,
          nodeModules: true,
