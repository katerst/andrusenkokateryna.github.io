...
describe('baconize', () => {
  ...
  describe('compile', () => {
    ...
    describe('after compilation', () => {
      it('should have all compiled files', () => Promise.all([
      ...
      it('should not copy pre-compiled files', () => fs
      ...
      it('should not compile blacklist matches', () => fs
      ...
      it('should not copy ignore paths', () => fs
  ...
  describe('compile with sourceMap', () => {
    ...
    describe('after compilation', () => {
      ...
      it('should URL link to source maps', () => Promise.all([
          fs.readFile(getPathOut('styles/main.css')),
          fs.readFile(getPathOut('scripts/main.js'))
        ]).then(results =>
          expect.promise.all([
      ...
      it('should have source maps', () => Promise.all([
      ...
      it('should copy pre-compiled source files', () => fs
          .readFile(getPathOut('index.jade'))
          .then(results =>
            expect(results.toString(), 'to contain', 'html(lang="en")')
          ));
  ...
  describe('minify', () => {
    ...
    describe('after compilation', () => {
      ...
      it('should copy pre-compiled files', () => fs
          .readFile(getPathOut('index.jade'))
  ...
  describe('compile minified with sourceMap (with broken js)', () => {
    ...
    before(() => 
      ...
      // Uglify doesn't support es6 so it should not minify the file and just silently move on
       fs
        .readFile(getPathIn('scripts/iterate.js'), 'utf8')
        .then(content => {
    ...
    describe('after compilation', () => {
      ...
      it('should copy pre-compiled source files', () => Promise.all([
          fs.readFile(getPathOut('index.jade')),
  ...
  describe('compile minified with sourceMap (SHA test)', () => {
    ...
    before(() => {
      ...
      const styl = fs
        .readFile(getPathIn('dont-copy/_inner.styl'), 'utf8')
        .then(content => {
          originalStylContents = content;
          return fs.writeFile(
            getPathIn('dont-copy/_inner.styl'),
            `${content} `
          );
        });
      ...
      return Promise.all([styl, html, randomFile, coffee]);
    });

    after((done) => {
      // NOTE: (REF:1) This will cause a re-compile in the next test
      const styl = fs.writeFile(
        getPathIn('dont-copy/_inner.styl'),
        originalStylContents
      );
      styl.then(done);
    });
    ...
    describe('after compilation', () => {
      ...
      it("should remove files that weren't in src dir", () => fs
      ...
      it('should not compile files prefixed with `_`', () => fs
  ...
  describe('compile minified with sourceMap (SHA test repeated)', () => {
    after(clearDir);
    ...
    it('should compile compilable files and copy all others', () => {
      ...
      return bacon.then(num =>
        expect.promise.all([
          ...
          expect(compiledFiles, 'to contain', 'styles/main.styl').and(
            'to have length',
            1
          ),
          expect(
  ...
  describe('aborted compile', () => {
    ...
    it('should abort during compile process', () => {
      ...
      return bacon.then(
        () =>
          expect.fail(
            'Baconize should not have completed, should have been aborted'
          ),
    ...
    describe('after aborted compilation', () => {
      it('should have removed all files', () => fs
          .readdir(getPathOut())
          .then(
